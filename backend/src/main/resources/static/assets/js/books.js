...
// Mark that this renderer is the in-stock renderer so other scripts (like main.js)
// can yield to it to avoid racing and duplicate DOM inserts.
window.__books_renderer_active = true;
